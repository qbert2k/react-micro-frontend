                    ...
                    <div className="p-8 0 dark:bg-gray-800 flex flex-col lg:w-full xl:w-3/5">
                        ...
                        <div className="mt-8">
                            <input
                                ...
                                type="email" name="" id="" placeholder="Email" value="abc@example.com"
                        ...
                        <div className="mt-2 flex-col">
                            <div>
                                <input
                                    ...
                                    type="text" name="" id="" placeholder="Name on card" value="John Doe"
                                    onChange={handleOnChange}/>
                            </div>
                        </div>

                        <label className="mt-8 text-base leading-4 text-gray-800 dark:text-gray-50">Country or
                            region</label>
                        <div className="mt-2 flex-col">
                            ...
                            <input
                                ...
                                type="text" name="" id="" placeholder="ZIP" value="400043"
                                onChange={handleOnChange}/>
                        </div>
